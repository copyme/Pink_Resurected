...
int main(int argc, char* argv[]) {
    ...
    nrs=ceil((double)rs/factor);
    ncs=ceil((double)cs/factor);
    nd=ceil((double)d/factor);

    factor_rs=(double)rs/(double)nrs;
    factor_cs=(double)cs/(double)ncs;
    factor_d=(double)d/(double)nd;
