...
static bool operator>(const Q &a, const Q &b) {
...
class RecoLR : public Reco {
public:
  point Sym(point &P) { return point(P.x, P.y); }
};
class RecoRL : public Reco {
public:
  point Sym(point &P) { return point(-P.x, P.y); }
};
class RecoBT : public Reco {
public:
  point Sym(point &P) { return point(P.y, P.x); }
};
class RecoTB : public Reco {
public:
  point Sym(point &P) { return point(-P.y, -P.x); }
};
